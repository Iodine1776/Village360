...
const pathways = [
  {
    ...
    title: "Build with us",
    body: "Pastors, nonprofit directors, school and court partners, and coalition builders who want collaborative support instead of another disconnected program.",
